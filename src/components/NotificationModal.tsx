        ...
        <div className="p-5 space-y-4 text-slate-800 text-xs">
          {result ? (
            <div className="text-center py-6 space-y-3">
              <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mx-auto text-[#0d4b8f]">
              ...
              <p className="text-xs text-slate-600 max-w-xs mx-auto">
                ...
                <span className="font-semibold text-[#0d4b8f] uppercase">{channel}</span>.
              </p>
              <button
                onClick={onClose}
                className="mt-2 px-5 py-2 rounded-lg bg-[#0d4b8f] text-white text-xs font-bold hover:bg-[#0b3f7a]"
              >
                Close & View Log
              </button>
            </div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  <button
                    ...
                    className={`p-2.5 rounded-lg border text-xs font-medium flex flex-col items-center gap-1 transition-all ${
                      channel === 'email'
                        ? 'bg-blue-50 border-[#0d4b8f] text-slate-900 ring-2 ring-blue-400 font-bold'
                        : 'bg-slate-50 border-slate-200 text-slate-700 hover:bg-slate-100'
                    }`}
                  >
                    <Mail className="w-4 h-4 text-[#0d4b8f]" />
                  ...
                  >
                    <MessageSquare className="w-4 h-4 text-[#0d4b8f]" />
                    <span>SMS Alert</span>
                  </button>
                  ...
                  >
                    <Bell className="w-4 h-4 text-[#0d4b8f]" />
        ...
        {!result && (
          <div className="bg-slate-50 px-5 py-3 border-t border-slate-200 flex justify-end gap-2">
            ...
            <button
              ...
              className="px-4 py-1.5 rounded-lg text-xs font-bold text-white bg-[#0d4b8f] hover:bg-[#0b3f7a] transition-colors shadow-sm disabled:opacity-50 flex items-center gap-1.5"
            >
